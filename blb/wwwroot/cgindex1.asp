...
<body>
<span style="color:blue;family-font:黑体;"><%=session("cgname")%></span>，尊敬的买家用户，你好！

<form name="form1" method="post" action="findcp.asp?page=1" > 
<tr><td><input type="text" name="na" class="editbox"  size="30" ></td></tr>
<tr><td><input type="submit" name="Submit"  class="but" value="搜索商品"> 
</td></tr> 
</form>
...
dim na
na=session("cgname")
exec="select * from cp where cgname Like '%"&na&"%'  order by id desc " 
...
我的订单列表
<table width="100%" border="1" cellspacing="1" cellpadding="0" backgroundcolor="darkgray"> 
<tr> 
...
<td style="background-color: whitesmoke; " align="center">图片信息</td>
<td style="background-color: whitesmoke; " align="center">销售方式</td>
<td style="background-color: whitesmoke; " align="center">产品操作</td>
...
<input type="submit" name="Submit" class="but" value="退出"> 
</form>
