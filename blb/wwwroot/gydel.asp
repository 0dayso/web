...
<title>删除界面-最大最多最全的商家商品交易市场</title>
...
exec="delete * from gy where id="&request.querystring("id")
conn.execute exec 
conn.close 
set conn=nothing 
response.write "<script>alert('供应用户已删除！');location.href='gyadmin.asp';</script>"
