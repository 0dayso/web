...
.top
{
family-face:黑体;font-size:25px;color:white;background-color:blue;
}
</style>
...
<input type="submit" class="but" name="Submit" value="发布产品"> <span>点击[发布产品]按钮发布你要卖的产品，在销售开通的状态下，买家可以找到你的商品订购。</span>
</form>
...
<input type="submit" class="but" name="Submit" value="退出"> 
</form>
