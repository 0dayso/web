...
<tr><td align="center" height="30px">商家名称 <input type="text" name="name" class="editbox" onfocus="on1()" onblur="out1()" id="text1" size="15"><br><span id="sp1" style="font-size:12px;color:red;background-color:yellow;padding:2px;position:fixed;display:none;">请输入买家商家名称</span> </td></tr>
...
<tr><td align="center" height="30px">商家名称 <input type="text" name="name" onfocus="on2()" onblur="out2()" class="editbox" id="text2" size="15"><br><span id="sp2" style="font-size:12px;color:red;background-color:yellow;padding:2px;position:fixed;display:none;">请输入卖家商家名称</span> </td></tr>
<tr><td align="center" height="30px">权限密码 <input type="password" name="password" class="editbox" id="text1" size="15">
</td></tr> 
<tr><td align="center" height="30px">验证码&nbsp;&nbsp;<img src="retest.asp" onclick="reabc(this);" title="点击图片可以更改验证码" height="13" width="52">
<input type="text" size="5" name="C" autocomplete="off" style="ime-mode:disabled;" value="">
