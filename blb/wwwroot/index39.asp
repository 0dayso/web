...
<body>
<div class="main">
<div class="h" style="font-size:60px;font-family:黑体;color:white;font-color:white;line-height:90px;background-color:YellowGreen;text-align:center;">
  &nbsp;百联百<font size="5px">http://www.bailianbai.com <font size="1px"></font>   &nbsp; &nbsp;  </font>
</div>
<table border="0" width="100%" align="center" bgcolor="whitesmoke" color="white"><td><div align="justify" style="display: block; font-size: 12px;"><marquee scrollamount="2" direction="left">
...
<tr><td align="center" height="30px">商家名称 <input type="text" name="name" class="editbox" onfocus="on1()" onblur="out1()" id="text1" size="15"><span id="sp1" style="font-size:12px;color:red;background-color:yellow;padding:2px;position:fixed;display:none;">请输入买家商家名称</span> </td></tr>
...
<tr><td align="center" height="30px">商家名称 <input type="text" name="name" onfocus="on2()" onblur="out2()" class="editbox" id="text2" size="15"><span id="sp2" style="font-size:12px;color:red;background-color:yellow;padding:2px;position:fixed;display:none;">请输入卖家商家名称</span> </td></tr>
<tr><td align="center" height="30px">权限密码 <input type="password" name="password" class="editbox" id="text1" size="15">
</td></tr> 
<tr><td align="center" height="30px">验证码&nbsp;&nbsp;<img src="retest.asp" onclick="reabc(this);" title="点击图片可以更改验证码" height="13" width="52">
<input type="text" size="5" name="C" autocomplete="off" style="ime-mode:disabled;" value="">
