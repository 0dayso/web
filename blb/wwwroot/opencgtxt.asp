...
<title>买家信息 百联百 最大最多最全的商家商品交易市场</title>
...
%> 
<form name="form1" method="post" action="checkcgtxt_save.asp"> 
<br><br><br><br>
...
<tr>
<td> 入采购金额:
<%=rs("cpearn")*1.1*rs("cpnum")%>
</td></tr>

<tr><td><textarea name="cgtxt" rows="7" cols="70" value="<%=rs("cgtxt")%>"></textarea></td></tr>


<td align="center"><input type="submit" name="Submit" value="通知采购"> 
